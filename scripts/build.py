...
def shell(title, description, body, depth=0, path="", kind="WebPage", extra_schema=None):
    ...
    footer = f'''<footer class="site-footer"><div><strong>BRAND METHOD</strong><p>By {e(CONFIG['author'])}. Marketing decisions, examined.</p></div><div>{contact}{linkedin}<a href="{root}contact/">Contact Akshat</a><br><a href="{root}privacy/">Privacy & analytics</a><p>Independent editorial analysis. No affiliation with brands discussed in Insights.</p></div></footer>'''
    ...
    analytics_id = CONFIG.get("google_analytics_id", "")
    analytics = f'''<script>window.BRAND_METHOD_ANALYTICS_ID={json.dumps(analytics_id)};window.dataLayer=window.dataLayer||[];window.gtag=window.gtag||function(){{dataLayer.push(arguments)}};window.loadBrandMethodAnalytics=function(){{if(window.brandMethodAnalyticsLoaded||!window.BRAND_METHOD_ANALYTICS_ID)return;window.brandMethodAnalyticsLoaded=true;const s=document.createElement('script');s.async=true;s.src='https://www.googletagmanager.com/gtag/js?id='+encodeURIComponent(window.BRAND_METHOD_ANALYTICS_ID);document.head.appendChild(s);gtag('js',new Date());gtag('config',window.BRAND_METHOD_ANALYTICS_ID,{{'anonymize_ip':true}})}};if(localStorage.getItem('brand_method_analytics')==='granted')window.loadBrandMethodAnalytics();</script>''' if analytics_id else ""
    consent = f'''<aside class="analytics-consent" data-analytics-consent hidden aria-label="Analytics choice"><p><strong>Can I count this visit?</strong> Optional analytics helps me see which essays people read and how they found the site. No advertising.</p><div><button type="button" data-analytics-allow>Allow analytics</button><button type="button" data-analytics-decline>No thanks</button><a href="{root}privacy/">Details</a></div></aside>''' if analytics_id else ""
    return f'''<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta name="theme-color" content="#291d37"><meta name="description" content="{e(description)}">{verification}<title>{e(full_title)}</title><link rel="canonical" href="{e(canonical)}"><meta property="og:type" content="{'article' if kind == 'Article' else 'website'}"><meta property="og:title" content="{e(full_title)}"><meta property="og:description" content="{e(description)}"><meta property="og:url" content="{e(canonical)}"><meta property="og:site_name" content="Brand Method"><meta property="og:image" content="{e(BASE + 'akshat-portrait.webp')}"><meta name="twitter:card" content="summary_large_image"><meta name="twitter:title" content="{e(full_title)}"><meta name="twitter:description" content="{e(description)}"><link rel="icon" href="{root}favicon.svg" type="image/svg+xml"><link rel="stylesheet" href="{root}styles.css"><script type="application/ld+json">{schema}</script>{analytics}</head><body><a class="skip-link" href="#main">Skip to content</a>{nav}<main id="main">{body}</main>{footer}{consent}<script src="{root}main.js" defer></script></body></html>'''
