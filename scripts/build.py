...
def render_about(site):
    ...
    <header class="about-opening"><div class="about-opening-copy"><p class="eyebrow">A NOTE FROM AKSHAT</p><h1>I have opinions.<br><em>Quite a few.</em></h1><p>About the brands I love. The products that frustrate me. And the decisions everyone seems to be talking around.</p></div><div class="about-scraps" aria-hidden="true"><span class="about-scrap about-scrap--love">LOVE THE IDEA.</span><span class="about-scrap about-scrap--why">BUT WHY<br>THIS WAY?</span><span class="about-scrap about-scrap--unsaid">THE PART<br>NO ONE SAYS.</span><span class="about-scrap-caption">NOTES FROM A MARKETER'S HEAD ↗</span></div></header>
